  ...
  module ParserMethods
    ...
    def parse_query(query=nil, options={}, models=nil)
      ...
      begin
        ...
        if options[:around]
          query_options[:radius] = options[:around][:radius].to_f
          query_options[:latitude] = options[:around][:latitude].to_f
          query_options[:longitude] = options[:around][:longitude].to_f
        end
